...
INSERT INTO
tbl_iolist (
io_date, io_time, io_pname, io_dname, io_dceo, io_div, io_quan, io_iprice,io_oprice
)
VALUES 
...
-- 2월10일이거나 2월25일이거나 3월7일인 날의 데이터를 보여줘
...
FROM tbl_iolist
GROUP BY io_pname;
-- 상품명이 같은게 있으면 group으로 묶어라
-- 그리고 그 그룹에 묶여있는 친구들만 SUM(합계)를 내서 보여줘
