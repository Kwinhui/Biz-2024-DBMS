...
/*
기존의 Table 구조 변경하기
칼럼에 이름을 변경하거나, 칼럼의 type 을 변경하는 일
FK 를 새로 설정하거나, PK 로 새로설정 또는 변경하는 일
ALTER TABLE ... 명령을 사용하여 변경한다.

기존 Table 구조를 변경할 때 발생할수 있는 여러가지 문제
1. 칼럼의 Type 을 변경 : 문자열 -> 숫자, 숫자 -> 문자, 저장공간 변경등
