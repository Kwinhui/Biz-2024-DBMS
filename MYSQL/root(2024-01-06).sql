...
-- columns의 순서와 values의 순서가 일치해야함
	'S0001', '갈한수',
    '기계공학과', '2',
...
-- 필수항목(NOT NULL) st_name 의 데이터가 준비되지 않아
-- 데이터 추가 실패
INSERT INTO 
tbl_student(st_num, st_dept)
VALUES ('S0003', '기계공학과');

-- 필수항목(NOT NULL) st_dept 의 데이터가 준비되지 않아
-- 데이터 추가 실패
INSERT INTO 
tbl_student(st_num, st_name)
VALUES ('S0003', '개원훈');
-- DML 에서의 CREATE 명령어는 DDL 에서 INSERT 이다
...
-- INSERT INTO
-- tbl_professor (
-- 	prof_num, prof_name, prof_tel)
-- VALUES ( 
-- 'P001',	'김유정', '090-2084-2933')
