...
정수값 : TINYINT, SMALLINT, INT(INTEGER), BIGINT
	TINYINT : 0 ~ 255(또는 -128 ~ 127)
    SMALLTIN : 0 ~ 65535(또는 -32768 ~ 32767)
...
/*
 ...
 이러한 중간의 임시장치를 Buffer, cache 라고 한다.
 이때, 여러곳의 client 가 동시에 DB 의 데이터에 접근 할 경우, 일부 client 에서는 
...
-- n96js 라는 사용자를 localhost 에서만 접근할 수 있도록 생성한다.
